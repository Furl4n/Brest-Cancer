...
salvar_coeficiente_com_contraste('Wavelets/V2/Resultados/resultado_Aproximacao_LL2.png', cA2)
salvar_coeficiente_com_contraste('Wavelets/V2/Resultados/resultado_Detalhe_Vertical_HL2.png', cV2)
salvar_coeficiente_com_contraste('Wavelets/V2/Resultados/resultado_Detalhe_Horizontal_LH2.png', cH2)
salvar_coeficiente_com_contraste('Wavelets/V2/Resultados/resultado_Detalhe_Diagonal_HH2.png', cD2)

# Nível 1 (detalhes finos)
salvar_coeficiente_com_contraste('Wavelets/V2/Resultados/resultado_Detalhe_Horizontal_LH1.png', cH1)
salvar_coeficiente_com_contraste('Wavelets/V2/Resultados/resultado_Detalhe_Vertical_HL1.png', cV1)
salvar_coeficiente_com_contraste('Wavelets/V2/Resultados/resultado_Detalhe_Diagonal_HH1.png', cD1)
