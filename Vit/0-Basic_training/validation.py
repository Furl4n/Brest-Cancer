...
MODEL_DIR = "Vit/Vit_checkpoints/checkpoint-3492"
TEST_DATASET_DIR = "dataset_orientado/dataset_val"
...
transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.2460, 0.2460, 0.2460], std=[0.2180, 0.2180, 0.2180])
])
...
plt.ylabel('Real')
plt.tight_layout()
plt.savefig('Vit/0-Basic_training/confusion_matrix.png', dpi=300, bbox_inches='tight')
