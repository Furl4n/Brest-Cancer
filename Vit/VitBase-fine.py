...
transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.3522, 0.3522, 0.3522], std=[0.2958, 0.2958, 0.2958])
])

# Carregue o dataset
dataset = ImageFolder(root="/home/pedro-furlan/Área de trabalho/IC - Breast cancer/Codigos/Vit/dataset", transform=transform)
...
training_args = TrainingArguments(
    output_dir="vit_cancer_finetune"
