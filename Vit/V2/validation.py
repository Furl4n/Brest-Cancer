...
MODEL_DIR = "/media/pedro-furlan/2E68-4926/Treinamento/checkpoint-V2"
TEST_DATASET_DIR = "dataset/dataset_train"
...
plt.ylabel('Real')
plt.tight_layout()
plt.savefig('Vit/V2/confusion_matrix.png', dpi=300, bbox_inches='tight')
